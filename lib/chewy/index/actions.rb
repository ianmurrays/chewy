  ...
  class Index
    ...
    module Actions
      ...
      module ClassMethods
        ...
        #
        # It also applies journal if anything was journalled during the
        # reset.
        #
        # @example
        #   UsersIndex.reset!
        ...
        # @param apply_journal [true, false] journal is applied after the import is completes
        # @param journal [true, false] journallig is switched of for import during reset by default
